...
public class Auto_1cone2cubeHPBlue_Cmd extends SequentialCommandGroup {
   ...
   */
  public Auto_1cone2cubeHPBlue_Cmd(
    ...
    SequentialCommandGroup armRotateAndExtendToHighLevelCubeFromPickupSequential =
        new SequentialCommandGroup(
            new Cmd_SubSys_Arm_RotateAndExtend(armSubSys, -158.0, true, 0, true).withTimeout(2.5),
    ...
    SequentialCommandGroup armRotateAndExtendToMidLevelCubeFromPickupSequential =
        new SequentialCommandGroup(
            new Cmd_SubSys_Arm_RotateAndExtend(armSubSys, -168, true, 0, true).withTimeout(2.5),
            new Cmd_SubSys_Arm_RotateAndExtend(armSubSys, -168, true, 1.08, true).withTimeout(3));
    ...
    ParallelCommandGroup armRotateAndExtendDriveToDeliverCube2MidLevelParallel =
        new ParallelCommandGroup(
            armRotateAndExtendToMidLevelCubeFromPickupSequential.withTimeout(
                5), // Lift arm to pickup pos
            new Cmd_SubSys_DriveTrain_FollowPathPlanner_Traj(
    ...
    addCommands(
        ...
        // new WaitCommand(0.5), // Add buffer time
        new InstantCommand(handSubSys::CloseHand),
        new Cmd_SubSys_Arm_RotateAndExtend(armSubSys, 45, true, 0, true)
            .withTimeout(4) // Lift arm to pickup pos
        );
  }
}
