...
package frc.robot.library.drivetrains.swerve_yagsl.commands;

import edu.wpi.first.math.geometry.Translation2d;
import edu.wpi.first.math.kinematics.ChassisSpeeds;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
import edu.wpi.first.wpilibj2.command.CommandBase;
import frc.robot.library.drivetrains.swerve_yagsl.ConstantsSwerveYAGSL;
...
public class AbsoluteDrive extends CommandBase
{
  ...
  private final SubSysSwerveYAGSL swerve;
   ...
   */
  public AbsoluteDrive(SubSysSwerveYAGSL swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingHorizontal,
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           ConstantsSwerveYAGSL.LOOP_TIME, ConstantsSwerveYAGSL.ROBOT_MASS, List.of(ConstantsSwerveYAGSL.CHASSIS),
